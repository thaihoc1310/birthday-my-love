...
$(document).ready(function () {
	...
	function positionBalloons() {
		...
		if ($(window).width() < 768) { // Adjust width threshold for mobile screens
			// Arrange balloons in two rows for smaller screens
			$('#b11').animate({ top: 180, left: vw - 150 }, 500);
			$('#b22').animate({ top: 180, left: vw - 50 }, 500);
			$('#b33').animate({ top: 180, left: vw + 50 }, 500);
			$('#b44').animate({ top: 180, left: vw + 150 }, 500);
			$('#b55').animate({ top: 300, left: vw - 150 }, 500);
			$('#b66').animate({ top: 300, left: vw - 50 }, 500);
	...
	// Initial call to position balloons
	positionBalloons();
});
